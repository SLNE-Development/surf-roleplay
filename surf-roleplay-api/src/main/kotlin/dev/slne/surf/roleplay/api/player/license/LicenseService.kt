...
private val licenseService = requiredService<LicenseService>()
...
interface LicenseService {
    ...
    companion object : LicenseService by licenseService {
        val INSTANCE get() = licenseService
    }
}
 ...
 * @return the license instance if found, or null if not found.
 */
inline fun <reified T : License> LicenseService.getLicense() = getLicense(T::class.java)
 ...
 * @throws IllegalArgumentException if the license is not found.
 */
inline fun <reified T : License> LicenseService.getLicenseOrThrow() =
